...
import org.example.macro.MisaParkMacro;
...
public class MacroApplication
{
    ...
    private static final LocalTime submitTime = LocalTime.of(9, 0, 4, (500 + (int) (Math.random() * 100)) * 1_000_000);
    ...
    public static void main(String[] args)
    {
        ...
        {
            sleepUntil(LocalDateTime.now().plusSeconds(2));
        }
